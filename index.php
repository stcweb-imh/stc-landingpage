  ...
  <style>
    ...
    *{box-sizing:border-box;margin:0;padding:0}
    ...
    .cta-btn{
      ...
      padding:14px 28px;
      border-radius:12px;
      background:linear-gradient(90deg,#0088cc, #00aadd);
      color:#fff;
      font-weight:600;
    ...
    .cta-btn:hover {
      ...
      background:linear-gradient(90deg,#0077bb, #0099cc);
    }
    .cta-btn::before{
      content:"";
      position:absolute;
    ...
    /* Telegram icon - Medium size */
    .cta-btn .fa-telegram-plane {
      font-size: 22px;
...
<body>
  ...
  <div class="container">
    <header class="hero">
      ...
      <div class="subtitle"> Advanced Signals • Live Sessions • Recover & Grow</div>
      ...
      <!-- Telegram CTA Section - Now in the middle -->
      <div class="cta-section">
        <a id="telegram-cta" class="cta-btn" href="https://t.me/SojibTrader" target="_blank">
          <i class="fa-brands fa-telegram-plane"></i> 
          Join Telegram Channel
        </a>
        <div class="redirect-notice" id="redirect-notice">Auto-redirecting to Telegram in <span id="countdown">3</span> seconds...</div>
        <div class="loading-note" id="loading-note"></div>
      </div>

      <!-- Benefits - Moved below the Telegram button -->
      <div class="benefits">
  ...
  <script>
    ...
    let redirectUrl = defaults.channelLink;
    ...
    siteRef.on('value', snapshot => {
      ...
      // Start auto-redirect countdown after data is loaded
      setTimeout(startAutoRedirect, 4000); // 4 seconds after page load
    }, error => {
      ...
      // Start auto-redirect countdown even if there's an error
      setTimeout(startAutoRedirect, 4000); // 4 seconds after page load
    });
  </script>
